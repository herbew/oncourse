...
from oncourse.libs.django_mongoengine.forms import fields as formfields
...
class ReferenceField(DjangoField):
    ...
    def formfield(self, **kwargs):
        defaults = {
          ...
          'query_set': self.document_type.objects,
        }
        defaults.update(kwargs)
    ...
    def formfield(self, **kwargs):
        if self.field.choices:
            ...
            defaults = {
                ...
                'query_set': self.field.document_type.objects,
            }
        else:
            defaults = {}
...
class EmbeddedDocumentField(DjangoField):
    ...
    def formfield(self, **kwargs):
        from oncourse.libs.django_mongoengine.forms.documents import documentform_factory
        defaults = {
            'label': self.label,
            'help_text': self.help_text,
        }

...
from oncourse.libs.django_mongoengine.fields import (ListField, EmbeddedDocumentField,
                                       ReferenceField, StringField)

from oncourse.libs.django_mongoengine.mongo_admin.util import RelationWrapper
from oncourse.libs.django_mongoengine.paginator import Paginator
from oncourse.libs.django_mongoengine.utils.wrappers import copy_class
from oncourse.libs.django_mongoengine.utils.monkey import get_patched_django_module
from oncourse.libs.django_mongoengine.forms.documents import (
...
# XXX: add inline init somewhere
    ...
    def get_changelist(self, request, **kwargs):
        ...
        """
        from oncourse.libs.django_mongoengine.mongo_admin.views import DocumentChangeList

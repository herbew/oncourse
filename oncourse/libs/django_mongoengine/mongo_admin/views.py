...
class DocumentChangeList(ChangeList):
    ...
    def get_results(self, request):
        # query_set has been changed to query_set
        try:
            self.queryset
        except:
            self.queryset = self.queryset
        # root_query_set has been changed to root_query_set
        try:
            self.root_query_set
        except:
    ...
    def get_ordering(self, request=None, query_set=None):
        """
        ...
        try:
            ...
            qs_ordering = [sign(t) + t[0] for t in query_set._ordering]
    ...
    def get_queryset(self, request=None):
        ...
        try:
            ...
            # Then, we let every list filter modify the query_set to its liking.

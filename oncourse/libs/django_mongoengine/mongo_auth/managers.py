...
MONGOENGINE_USER_DOCUMENT = getattr(
    settings, 'MONGOENGINE_USER_DOCUMENT', 'oncourse.libs.django_mongoengine.mongo_auth.models.User')
...
class MongoUserManager(UserManager):
    ...
    the user model. In you settings.py, you need:
        ...
        INSTALLED_APPS = (
            ...
            'django.contrib.auth',
            'oncourse.libs.django_mongoengine.mongo_auth',
            ...
        )
        AUTH_USER_MODEL = 'mongo_auth.MongoUser'

    Django will use the model object to access the custom Manager, which will
    replace the original query_set with MongoEngine query_sets.

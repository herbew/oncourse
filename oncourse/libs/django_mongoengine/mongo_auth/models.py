...
from oncourse.libs.django_mongoengine import document
from oncourse.libs.django_mongoengine import fields
from oncourse.libs.django_mongoengine.queryset import QuerySetManager
...
class MongoUser(BaseUser, models.Model):
    ...
    The actual user document class is oncourse.libs.django_mongoengine.auth.models.User or any

...
from oncourse.libs.modeltranslation import admin, settings as mt_settings, translator
from oncourse.libs.modeltranslation.forms import TranslationModelForm
from oncourse.libs.modeltranslation.manager import MultilingualManager
from oncourse.libs.modeltranslation.models import autodiscover
from oncourse.libs.modeltranslation.tests.test_settings import TEST_SETTINGS
from oncourse.libs.modeltranslation.utils import (build_css_class, build_localized_fieldname,
    ...
    def setUpClass(cls):
        ...
        * Call syncdb to create tables for tests.models (since during
        ...
        if not ModeltranslationTransactionTestBase.synced:
            ...
            from oncourse.libs.modeltranslation.tests import models, translation  # NOQA
...
class FallbackTests(ModeltranslationTestBase):
    ...
    def test_resolution_order(self):
        from oncourse.libs.modeltranslation.utils import resolution_order
        with reload_override_settings(MODELTRANSLATION_FALLBACK_LANGUAGES=self.test_fallback):
...
class ForeignKeyFieldsTest(ModeltranslationTestBase):
    ...
    def test_reverse_lookup_with_filtered_query_set_manager(self):
        """
        Make sure base_manager does not get same query_set filter as TestModel in reverse lookup
        https://docs.djangoproject.com/en/3.0/topics/db/managers/#base-managers
        """
        from oncourse.libs.modeltranslation.tests.models import FilteredManager
...
class TestManager(ModeltranslationTestBase):
    ...
    def test_custom_manager_custom_method_name(self):
        ...
        from oncourse.libs.modeltranslation.manager import MultilingualQuerySet
    ...
    def test_multilingual_query_set_pickling(self):
        import pickle
        from oncourse.libs.modeltranslation.manager import MultilingualQuerySet
    ...
    def test_custom_manager2(self):
        """Test if user-defined query_set is still working"""
        from oncourse.libs.modeltranslation.manager import MultilingualManager, MultilingualQuerySet
    ...
    def test_translation_fields_appending(self):
        from oncourse.libs.modeltranslation.manager import append_lookup_keys, append_lookup_key
    ...
    def test_distinct(self):
        ...
        # query_set it can appear that there are duplicates (the titles in this case)

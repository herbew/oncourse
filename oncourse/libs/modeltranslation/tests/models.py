...
class CustomManager(models.Manager):
    def get_queryset(self):
        ...
        query_set = sup.get_queryset() if hasattr(sup, 'get_queryset') else sup.get_queryset()
        return query_set.filter(title__contains='a').exclude(description__contains='x')

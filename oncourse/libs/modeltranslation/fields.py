...
from oncourse.libs.modeltranslation.utils import (
    get_language, build_localized_fieldname, build_localized_verbose_name, resolution_order)
from oncourse.libs.modeltranslation.widgets import ClearableWidgetWrapper
    ...
    def formfield(self, *args, **kwargs):
        ...
        if isinstance(formfield, forms.CharField):
            if self.empty_value is None:
                from oncourse.libs.modeltranslation.forms import NullCharField
                ...
                from oncourse.libs.modeltranslation.forms import NullableField
                form_class = formfield.__class__
                kwargs['form_class'] = type(

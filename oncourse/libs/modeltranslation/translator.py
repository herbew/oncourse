...
from oncourse.libs.modeltranslation import settings as mt_settings
from oncourse.libs.modeltranslation.fields import (NONE, create_translation_field, TranslationFieldDescriptor,
                                     TranslatedRelationIdDescriptor,
                                     LanguageCacheSingleObjectDescriptor)
from oncourse.libs.modeltranslation.manager import (MultilingualManager, MultilingualQuerysetManager,
                                      rewrite_lookup_key, append_translated)
from oncourse.libs.modeltranslation.utils import build_localized_fieldname, parse_field
...
def has_custom_query_set(manager):
    "Check whether manager (or its parents) has declared some custom get_queryset method."
    old_diff = getattr(manager, 'get_queryset', None) != getattr(Manager, 'get_queryset', None)
...
from oncourse.libs.modeltranslation.decorators import register  # NOQA re-export
